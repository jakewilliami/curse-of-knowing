...
\begin{document}
	\begin{tikzpicture}[node distance=8em]		
		...
		\node(n6-1)[demo,below of=n5-1]{Further country demographics, and hometown demographics};
		\node(n6-2)[demo,below of=n5-2]{Further hometown demographics, and country demographics};
